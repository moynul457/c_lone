...
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94m➣YouTube  : TECHNICAL SAA
\x1b[1;94m➣Note     : Dont ReEdit It 
\x1b[1;94m➣Github   : https://github.com/Technical-SAA
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;97mAccess Granted "#Dev:Technical-SAA
	    time.sleep(1)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		jalan(' \033[1;97m   ✧ \033[1;97m👉 : \033[1;97mTechnical SAA Of Facebook' ) 
...
def hop():
	...
	if hack =="":
		...
		super()
	        ...
	        os.system('xdg-open https://chat.whatsapp.com/F0JeMeOgVq78AR5QBJL5Rs')
	        menu()
